...
zookeeper.ssl.keystore.location=/opt/drycc/kafka/config/certs/zookeeper.keystore.jks
zookeeper.ssl.truststore.location=/opt/drycc/kafka/config/certs/zookeeper.truststore.jks
