...
- name: OPENSEARCH_PASSWORD_FILE
  value: "/opt/drycc/opensearch/secrets/opensearch-password"
- name: OPENSEARCH_DASHBOARDS_PASSWORD_FILE
  value: "/opt/drycc/opensearch/secrets/opensearch-dashboards-password"
- name: LOGSTASH_PASSWORD_FILE
  value: "/opt/drycc/opensearch/secrets/logstash-password"
{{- else }}
...
- name: OPENSEARCH_KEYSTORE_LOCATION
  value: "/opt/drycc/opensearch/config/certs/{{ .Values.security.tls.keystoreFilename }}"
- name: OPENSEARCH_TRUSTSTORE_LOCATION
  value: "/opt/drycc/opensearch/config/certs/{{ .Values.security.tls.truststoreFilename }}"
{{- end }}
...
- name: OPENSEARCH_KEYSTORE_PASSWORD_FILE
  value: {{ printf "/opt/drycc/opensearch/secrets/%s" (include "opensearch.keystorePasswordKey" .) }}
{{- else }}
...
{{- if .Values.usePasswordFiles }}
- name: OPENSEARCH_KEYSTORE_PASSWORD_FILE
  value: {{ printf "/opt/drycc/opensearch/secrets/%s" (include "opensearch.truststorePasswordKey" .) }}
{{- else }}
...
- name: OPENSEARCH_KEY_PASSWORD_FILE
  value: {{ printf "/opt/drycc/opensearch/secrets/%s" (include "opensearch.keyPasswordKey" .) }}
{{- else }}
