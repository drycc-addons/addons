...
{{- if contains "bitnami/" .Values.image.repository }}
  [ -f /opt/drycc/postgresql/tmp/.initialized ] || [ -f /drycc/postgresql/.initialized ]
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated }}
    {{- printf "/opt/drycc/postgresql/certs/tls.crt" -}}
{{- else -}}
    {{- required "Certificate filename is required when TLS in enabled" .Values.tls.certFilename | printf "/opt/drycc/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated }}
    {{- printf "/opt/drycc/postgresql/certs/tls.key" -}}
{{- else -}}
{{- required "Certificate Key filename is required when TLS in enabled" .Values.tls.certKeyFilename | printf "/opt/drycc/postgresql/certs/%s" -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.tls.autoGenerated }}
    {{- printf "/opt/drycc/postgresql/certs/ca.crt" -}}
{{- else -}}
    {{- printf "/opt/drycc/postgresql/certs/%s" .Values.tls.certCAFilename -}}
{{- end -}}
{{- end -}}
...
{{- printf "/opt/drycc/postgresql/certs/%s" .Values.tls.crlFilename -}}
{{- end -}}
{{- end -}}
