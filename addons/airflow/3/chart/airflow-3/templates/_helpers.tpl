...
- name: AIRFLOW__CORE__FERNET_KEY_CMD
  value: "cat /opt/drycc/airflow/secrets/airflow-fernet-key"
- name: AIRFLOW__WEBSERVER__SECRET_KEY_CMD
  value: "cat /opt/drycc/airflow/secrets/airflow-secret-key"
{{- if (include "airflow.isImageMajorVersion3" .) }}
- name: AIRFLOW__API_AUTH__JWT_SECRET_CMD
  value: "cat /opt/drycc/airflow/secrets/airflow-jwt-secret-key"
{{- end }}
{{- else }}
